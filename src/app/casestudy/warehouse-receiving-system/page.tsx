            ...
            <section className='w-screen min-h-screen bg-[var(--primary-color)] flex pt-20 z-50 flex-auto flex flex-col p-20  pb-10'>
                <div className='bg-[var(--primary-color)]  w-full m-auto flex flex-col flex-nowrap mt-20 z-50 gap-10 max-w-7xl justify-center md:flex-row  text-gray-950'>
                    <div className='flex-auto  basis-md  md:basis-1/3 xl:basis-1/3 gap-2'>
                        <h1 className='text-2xl mb-2 font-bold'>Warehouse Receiving System</h1>
                        <p className='text-base mb-10'>IKEA planned to set up a pick-up point in Macau in 2016 and a retail store in 2020. The Hong Kong warehouse serves as a transfer terminal to support the Macau business, but its throughput is nearing full capacity. Therefore, optimizing warehouse operations is essential for supporting business growth.</p>
                        <p className='text-base mb-10'>The Warehouse Receiving System was designed for IKEA to optimize its warehouse operations, particularly the receiving process. In this project, I served as the project manager, overseeing the design and development of the system to enhance warehouse operations.</p>
                        ...
                        <div className='flex-col flex justify-around gap-2 p-3 w-full md:max-w-xs border-2 rounded-md border-[var(--second-color)] bg-[#457b9d] text-white'>
                            ...
                            <div className='flex-row flex justify-between'><span className='font-bold'>Year:</span> <span>2019</span></div>
                            <div className='flex-row flex justify-between'><span className='font-bold'>Role:</span> <span>Project Management, System design, web developer</span></div>
                            <div className='flex-row flex justify-between'><span className='font-bold'>Technologies:</span>
                                <span className='flex-col flex text-right gap-2'>
                                    Marketing Research, Business Analysis, System Design, Database Design
                                </span></div>

                        </div>

                        <div className='mt-5 w-full md:max-w-xs flex flex-col gap-5 '>
                            ...
                            <a href="https://github.com/Michelle2317/GoldiBite" target='_blank' className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full w-full block text-center'>Download PDF File</a>
                        </div>
