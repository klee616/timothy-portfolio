...
import React from "react";
 ...
 export const ImgComparison = ({ image1 ,image2  }:{
    image1:string,
    image2:string
 }  ) => 
    {
    return <>
        <ImgComparisonSlider className={`slider-with-animated-handle ${styles.colouredSlider}`}>
            <figure slot='first' className='m-0'>
                <img src={image1} />
                <figcaption className='bg-white border border-gray-400 rounded-xl text-[#2e3452] opacity-80 p-3 absolute top-1/2 transform -translate-y-1/2 leading-none left-3'>HiFi</figcaption>
            </figure>
