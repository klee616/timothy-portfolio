...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[300vh] py-40 overflow-hidden  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d] bg-[var(--primary-color)] -translate-y-[30vh] "
    >
      <Header />
      <motion.div
        style={{
...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 xl:py-auto 2xl:py-auto px-4 w-full translate-y-[30vh] left-0 top-0">
      <h1 className="text-2xl md:text-7xl lg:text-7xl 2xl:text-9xl font-bold dark:text-white">
...
export const ProductCard = ({
  ...
  return (
    <motion.div
      ...
      key={product.title}
      className="group/product h-[600px] w-[240px] relative flex-shrink-0"
    >
