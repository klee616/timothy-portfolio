  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className={`text-4xl sm:text-3xl  md:text-4xl   mb-4 text-black dark:text-white max-w-4xl`}>
          More About Me
        </h2>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <h3 className="hidden md:block text-lg md:pl-20 md:text-5xl font-bold text-neutral-500 dark:text-neutral-500 sm:text-lg font-semibold">
                {item.title}
              </h3>
            </div>
